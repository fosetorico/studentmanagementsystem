...
# Overriding Django default Auth user & adding user_type
# user type 1:Admin, 2:Staff, 3:Student
...
class FeedBackStudent(models.Model):
    ...
    feedback_reply = models.TextField(max_length=255)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now_add=True)     
    objects = models.Manager()   
...
# When data is added in CustomUser
@receiver(post_save, sender=CustomUser)
# Function which adds data into HOD, Staff, Student Table
