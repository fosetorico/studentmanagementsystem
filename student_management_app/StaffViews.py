...
def staff_home(request):
  ...
  # Fetch All Attendance Data by Subject
    subject_list = []
    attendance_list = []
    for subject in subjects:
...
def get_students(request):
    ...
    course = Courses.objects.get(id=subject.id)
...
def save_student_result(request):
    ...
    try:
        ...
        if check_exist:
            ...
            result.subject_total_marks = int(assignment_marks) + int(exam_marks)
            result.save()
            messages.success(request, "Successfully Updated Result for this Student")
            return HttpResponseRedirect(reverse("staff_add_result"))
        else:
            result = StudentResult(student_id=student_obj, subject_id=subject_obj, subject_exam_marks=exam_marks, subject_assignment_marks=assignment_marks)
            result.save()
            messages.success(request, "Successfully Added Result for this Student")
            return HttpResponseRedirect(reverse("staff_add_result"))
    except:
