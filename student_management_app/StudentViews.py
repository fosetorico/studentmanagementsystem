...
from student_management_app.models import StudentResult, NotificationStudent, LeaveReportStudent, FeedBackStudent, CustomUser, Attendance, AttendanceReport, Staffs, Courses, Subjects, Students, SessionYearModel
